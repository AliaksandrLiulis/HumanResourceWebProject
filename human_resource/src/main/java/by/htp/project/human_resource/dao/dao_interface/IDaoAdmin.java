...
public interface IDaoAdmin {
	...
	/**
	 * method which update fild {@link User#avaliable} for users by
	 * {@link User#userId} and Installed value
	 * 
	...
	/**
	 * method which delete {@link User} from base by {@link User#userId}
	 * 
	 * @return boolean value
	 */
	boolean deleteUserFromBase(int idUser) throws DaoException;
