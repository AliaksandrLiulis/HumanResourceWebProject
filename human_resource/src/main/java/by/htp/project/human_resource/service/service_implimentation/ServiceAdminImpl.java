...
public class ServiceAdminImpl implements IServiceAdmin {
	...
	private static final Logger logger = LoggerFactory.getLogger(ServiceAdminImpl.class);
	...
	public void getRegisteredUserByParam(final HttpServletRequest request, final HttpServletResponse response)
		...
		goOnPage(request, response, goToPage, "getRegisteredUserByParam");
	}
	...
	public void getUnRegisteredUserByParam(final HttpServletRequest request, final HttpServletResponse response)
		...
		goOnPage(request, response, goToPage, "getUnRegisteredUserByParam");
	}
	...
	public void getALLUserByParam(final HttpServletRequest request, final HttpServletResponse response)
		...
		goOnPage(request, response, goToPage, "getALLUserByParam");
	}
	...
	public void deleteUser(final HttpServletRequest request, final HttpServletResponse response) throws IOException {
		...
		goOnPageBySendRedirect(response, goToPage, "deleteUser");
	}
	...
	public void addUser(final HttpServletRequest request, final HttpServletResponse response) throws IOException {
		...
		goOnPageBySendRedirect(response, goToPage, "addUser");
	}
	...
	public void getAllMessage(HttpServletRequest request, HttpServletResponse response)
		...
		goOnPage(request, response, goToPage, "getAllMessage");
	}
	...
	public void deleteMessage(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		goOnPageBySendRedirect(response, goToPage, "deleteMessage");
	}
	...
	@Override
	public void deleteUserFromBase(HttpServletRequest request, HttpServletResponse response) throws IOException {
		String idUser = null;
		String goToPage = null;
		idUser = request.getParameter(ServiceParamConstant.USER_ID_PARAM);

		try {
			if (daoAdmin.deleteUserFromBase(Integer.parseInt(idUser))) {
				goToPage = "controllerServlet?command=cb.admin_page&user_delete_message=1";
			} else {
				goToPage = "controllerServlet?command=cb.admin_page&emptyuser=1";
			}
		...
		goOnPageBySendRedirect(response, goToPage, "deleteUserFromBase");
	}
	...
	private void goOnPage(final HttpServletRequest request, final HttpServletResponse response, String goToPage,
		...
		try {
			...
			logger.error("ServiceAdminImpl: " + methodName + ": ", e);
			throw e;
		}
	}
	...
	private void goOnPageBySendRedirect(final HttpServletResponse response, String goToPage, final String methodName)
		...
		try {
			...
			logger.error("ServiceAdminImpl: " + methodName + " : errorSendRedirect", e);
			throw e;
		}
	}
